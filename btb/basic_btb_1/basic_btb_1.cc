...
constexpr std::size_t BTB_WAY = 16;
constexpr std::size_t BTB_INDIRECT_SIZE = 8192;
constexpr std::size_t RAS_SIZE = 128;
constexpr std::size_t CALL_SIZE_TRACKERS = 2048;
